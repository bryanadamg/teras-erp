...
export const overviewPage: DocPage = {
    ...
    badges: ['Inventory', 'Manufacturing', 'BOM', 'Dyeing', 'Sales', 'Dispatch', 'Purchase', 'Traceability', 'Reports'],
    sections: [
        {
        ...
        },
        {
            ...
            items: [
                ...
                'Packaging-unit tallies (cones / boxes / drums) tracked alongside base quantity, plus a Booking Stock view of net-free availability across every open order',
                'Quality grading and quarantine holds that keep rejected or unreleased material out of both production and packing without blocking the good stock next to it',
                'A shop-floor Work Queue that ranks each work centre\'s open Work Orders by real material readiness, not just by date',
                'Dyeing & Setting wet-processing — dye recipes, Kartu Celup printouts, dyeing/setting runs, and fabric and yarn lab dip colour approval',
                'Sales and Purchase order lifecycle management, goods receipts with supplier delivery notes, and print-ready A4 templates',
                'A Packing → Pick List → Shipment dispatch pipeline with a four-eyes staging/verification gate before goods actually leave',
        ...
        },
        {
            heading: 'Module Map',
            items: [
                'Inventory — Items, Attributes, Variants, Colour/Combo Libraries, Categories, UOM, Lot Tracking',
                'Stock — Locations, Location Categories, Stock Balances, Booking Stock, Lots, Packaging Units, Ledger, Scanner Terminal',
                'BOM Designer — Recursive BOMs, Routing, Percentage Quantities, Variant BOMs, Automator',
                'Manufacturing — Production Runs, Manufacturing Orders, Work Orders, Work Queue, Beaming, Weaving Monitor, Consolidation',
                'Quality & Quarantine — Reject Grading, Defect-Store Routing, Quarantine Holds',
                'Sales — Sales Orders, Customer Management, Produce-to-Order, Lineage',
                'Packing & Dispatch — Packing Orders, Pick Lists, Shipments, Delivery Notes',
                'Purchase — Purchase Orders, Supplier Management, Goods Receipt, Delivery Notes',
                'Dyeing & Setting — Fabric & Yarn Lab Dips, Dye Recipes, Dyeing Runs, Setting Runs',
                'Samples & PLM — Sample Masters, Sample Requests, Approval Workflow',
                'Dashboard & Reports — KPIs, Smart Advisor, Production Output, Analytics',
                'Administration — Settings, Print Layouts, Users, Roles, Audit Logs',
            ],
        },
    ],
};
