...
export default function StockEntryView({ items, locations, stockBalance, onRecordStock }: any) {
                                  ...
                                  {stockBalance.map((bal: any, idx: number) => (
                                      <tr key={idx}>
                                          <td className="ps-4">
                                              ...
                                              {bal.variant_id && <div className="badge bg-light text-dark border mt-1">{getVariantName(bal.item_id, bal.variant_id)}</div>}
                                          </td>
