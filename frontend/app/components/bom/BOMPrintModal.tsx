...
import { CODE_FONT, xpFont, BUTTON_RADIUS, XP_BTN } from '../shared/xpTheme';
            ...
            <PrintModalShell modeless title={`Print BOM — ${bom.code}`} onClose={onClose} width="calc(var(--app-vw) * 90 / 100)" maxWidth={980} height="calc(var(--app-vh) * 88 / 100)">
                    ...
                    <div style={{ padding: '8px 12px', borderTop: '1px solid #dee2e6', background: '#f8f9fa', display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexShrink: 0 }}>
                        ...
                        <div style={{ display: 'flex', gap: 6 }}>
                            <button className={XP_BTN} style={{ fontFamily: xpFont, fontSize: 11, padding: '3px 12px', background: 'linear-gradient(to bottom,#fff,#d4d0c8)', border: '1px solid', borderColor: '#dfdfdf #808080 #808080 #dfdfdf', cursor: 'pointer', borderRadius: BUTTON_RADIUS }} onClick={onClose}>Close</button>
                            <button className={XP_BTN} style={{ fontFamily: xpFont, fontSize: 11, padding: '3px 14px', background: 'linear-gradient(to bottom,#5ec85e,#2d7a2d)', border: '1px solid', borderColor: '#1a5e1a #0a3e0a #0a3e0a #1a5e1a', color: '#fff', cursor: 'pointer', fontWeight: 'bold', borderRadius: BUTTON_RADIUS }}
