...
/**
 * Kartu Kerja (WO step card) body for BEAMING work centers — A6-optimised, floor-readable.
 * Carries the "Ends/Utas" field, which only applies to beam-producing steps.
 * Selected by ./KartuKerjaCard (the type dispatcher) via work_center_type === 'BEAMING'.
 */
export default function KartuKerjaCardBeaming({
    workOrder,
    parentMO,
    qrDataUrl,
    settings,
