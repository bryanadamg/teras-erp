 ...
 * that doesn't yet have a dedicated card (WARPING, WEAVING, DYEING, SETTING,
 * FINISHING, GENERAL). Selected by ./KartuKerjaCard, the type dispatcher.
 * Layout/fields to be refined per machine type later.
 */
export default function KartuKerjaCardGeneral({
    workOrder,
    parentMO,
    qrDataUrl,
    settings,
    ...
    // Fall back to all BOM lines when the step has no material mapped (e.g. un-routed BOM).
        ...
        <div style={{ fontFamily: PRINT_FONT, color: '#000', lineHeight: 1.3, display: 'flex', flexDirection: 'column', flex: 1, minHeight: 0 }}>
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', borderBottom: '2px solid #000', paddingBottom: '5px', marginBottom: '6px', gap: '8px' }}>
                <div style={{ display: 'flex', flexDirection: 'column', gap: '1px', minWidth: 0 }}>
                    <div style={{ fontSize: '12px', fontFamily: CODE_FONT, fontWeight: 'bold' }}>{parentMO?.code || workOrder.mo_code || '—'}</div>
